...
public class PasswordHash {
    ...
    public static void main(String[] args) {
        String 明文 = "睡桥洞是不可能的，这辈子不可能睡桥洞的，只能睡睡公园，才能维持现在的生活了。";
        String 密文 = PasswordHash.createHash("睡桥洞是不可能的，这辈子不可能睡桥洞的，只能睡睡公园，才能维持现在的生活了。", UUIDUtils.uuid());
        System.out.println("明文:" + 明文);
        System.out.println("密文:" + 密文);//1000:2C9080AC6372A1DB016372A1DBFB0000:df8115adecac908f3e2740c61dde65fc1554370f3a4a1700
        boolean b = PasswordHash.validatePassword(明文, 密文);
